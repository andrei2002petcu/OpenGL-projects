...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1)), //1
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1)), //2
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1)), //3
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], glm::vec3(-0.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(0.5f, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 0));
