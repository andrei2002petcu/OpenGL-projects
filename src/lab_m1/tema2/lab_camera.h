    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newForward = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 0);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newForward = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(newForward));

            glm::vec4 newRight = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newRight = glm::rotate(glm::mat4(1), angle, forward) * glm::vec4(right, 0);
            right = glm::normalize(glm::vec3(newRight));

            glm::vec4 newForward = glm::rotate(glm::mat4(1), angle, forward) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(newForward));
